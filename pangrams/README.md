...
Currently ~6 productive instances of the search are running, covering something less than 1% of the search area remaining per week.

- D-Z are complete (representing ~17% of the search space).
- A, B, and C are in progress.
- Searches from 522 of 2149 head words starting with A (255/718), B (96/710), or C (171/721) are complete.
- About 39.5% of the total search space has been covered to date.

##### Counts
- 13,793,597 "base" pangrams (without expanding anagrams) have been found. 
- 22,853,865 total pangrams (with anagrams expanded) have been found.
- 12,611 of 14,855 valid guesses (85%) appear in pangrams found to date.
- 2,062 of 2,316 known potential solutions (89%) appear in pangrams found to date.

The following 95 known potential solutions (4.1%) have not been found in any pangrams yet, and yielded no pangrams when the search started from that word (which is more consequential for words earlier in the alphabet than later, due to the basic search optimization of proceeding only with lexically-greater words from the head word).
~~~text
ABASE ABBEY ABUSE
BASIS
CACAO COCOA
...
POSSE PUPPY
RELAY REUSE RISER ROUSE ROYAL
RULER
SALSA SAUTE SEEDY SENSE SHALE
SHALL SHARE SHEAR SHEER SHELL
SHIRE SHORE SHUSH SILLY SISSY
SLASH SLYLY SOLAR SOOTY SORRY
STEAD STEED STOUT SUITE SULLY
SURER SUSHI
TASTY TATTY TESTY
UNION USHER
YEAST
